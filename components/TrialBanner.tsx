...
interface TrialBannerProps {
  ...
  stripeCustomerId: string | null; // reserved for future direct portal redirect
  dark: boolean;
}

export default function TrialBanner({ status, trialEndDate, hasPaymentSetup, dark }: TrialBannerProps) {
      ...
      return (
        <div className={`px-4 py-3 flex items-center justify-between gap-4 text-sm ${
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span>Add payment details before your trial ends to keep access.</span>
            <Link
              href="/pricing"
  ...
  // Past-due banner — non-dismissable, direct fix link
  if (status === 'PAST_DUE') {
    return (
        ...
        <span className="flex-1">
          ...
          <Link
            ...
            className={`font-medium underline underline-offset-2 ${
              dark ? 'text-red-300 hover:text-red-100' : 'text-red-900 hover:text-red-700'
            }`}
          >
