...
import { PLANS, LAUNCH_DISCOUNT, LAUNCH_DISCOUNT_LABEL } from '@/lib/plans';
              ...
              <div key={plan.tier}
                ...
                <div className="mt-4">
                  ...
                  <p className={`mt-1 text-xs ${dark ? 'text-gray-500' : 'text-gray-400'}`}>
                    ${(plan.fullPrice * LAUNCH_DISCOUNT).toFixed(2)} NZD/mo incl. GST
                  </p>
                  <p className={`text-xs mt-0.5 font-medium text-green-500`}>
                    Coupon LAUNCH50 applied automatically at checkout
                  </p>
                </div>
