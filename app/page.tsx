...
const FAQ_ITEMS: FaqItem[] = [
  { question: 'What is CloudPro Books?', answer: 'A modern business platform built for NZ freelancers and small businesses. Invoicing, expenses, payroll, client management, and financial reporting — all in one place.' },
  { question: 'Is CloudPro Books GST compliant?', answer: 'Yes. All invoices include GST at the standard NZ rate of 15%. Invoices follow the IRD requirements for valid tax invoices.' },
  ...
  { question: 'Is my data secure?', answer: 'Absolutely. CloudPro Books runs on AWS with Cognito authentication, encrypted storage, and owner-scoped data isolation. Your data is never accessible to other users.' },
